...
hdlr = logging.FileHandler('./log/log_test_pruned_{}.log'.format(currenttime))
...
def test(traindatadir, testdatadir, traindatacsv,testdatacsv,device,model_path,cfg_path):
    """
...
if __name__ == '__main__':
    ...
    model_path = os.path.join(config.get('DataPath','checkpoint_dir'),config.get('SaveModel','finetuned_prunedmodel'))
    ...
    test(datapath,test_datapath,csvpath,test_csv_path,device,model_path,cfg_path)
